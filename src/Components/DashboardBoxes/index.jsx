  ...
  return (
    <div>
      ...
      >
        ...
        <SwiperSlide>
            <div className='box p-5 bg-white cursor-pointer hover:bg-[#f1faff] rounded-md border border-[rgba(0,0,0,0.1)] flex items-center gap-4'>
            <TbBrandProducthunt className='text-[40px] text-[#321be1d8]'/>
                <div className='info w-[70%]'>
                   <h3>Total Products</h3>
                   <b>1,390</b>
                </div>
                <IoStatsChartSharp className='text-[50px] text-[#321be1d8]'/>
            </div>
        </SwiperSlide>
